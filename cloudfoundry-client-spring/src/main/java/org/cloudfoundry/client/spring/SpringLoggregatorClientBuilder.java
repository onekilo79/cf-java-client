...
import org.cloudfoundry.client.spring.loggregator.AuthorizationConfigurator;
...
public final class SpringLoggregatorClientBuilder {
    ...
    public SpringLoggregatorClientBuilder withCloudFoundryClient(CloudFoundryClient cloudFoundryClient) {
    ...
    public LoggregatorClient build() {
        ...
        return new SpringLoggregatorClient(getClientEndpointConfig(), this.webSocketContainer, root);
    }
